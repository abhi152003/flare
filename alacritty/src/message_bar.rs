...
mod tests {
    ...
    fn appends_close_button() {
        ...
        let size = SizeInfo::new(7., 10., 1., 1., 0., 0., false, 0.0);
    ...
    fn multiline_close_button_first_line() {
        ...
        let mut message_buffer = MessageBuffer::default();
        message_buffer.push(Message::new(input.into(), MessageType::Error));
        let size = SizeInfo::new(6., 10., 1., 1., 0., 0., false, 0.0);
    ...
    fn empty_with_shortterm() {
        ...
        let mut message_buffer = MessageBuffer::default();
        message_buffer.push(Message::new(input.into(), MessageType::Error));
        let size = SizeInfo::new(6., 0., 1., 1., 0., 0., false, 0.0);
    ...
    fn truncates_long_messages() {
        ...
        let mut message_buffer = MessageBuffer::default();
        message_buffer.push(Message::new(input.into(), MessageType::Error));
        let size = SizeInfo::new(22., (MIN_FREE_LINES + 2) as f32, 1., 1., 0., 0., false, 0.0);
    ...
    fn hide_button_when_too_narrow() {
        ...
        let mut message_buffer = MessageBuffer::default();
        message_buffer.push(Message::new(input.into(), MessageType::Error));
        let size = SizeInfo::new(2., 10., 1., 1., 0., 0., false, 0.0);
    ...
    fn hide_truncated_when_too_narrow() {
        ...
        let mut message_buffer = MessageBuffer::default();
        message_buffer.push(Message::new(input.into(), MessageType::Error));
        let size = SizeInfo::new(2., (MIN_FREE_LINES + 2) as f32, 1., 1., 0., 0., false, 0.0);
    ...
    fn add_newline_for_button() {
        ...
        let mut message_buffer = MessageBuffer::default();
        message_buffer.push(Message::new(input.into(), MessageType::Error));
        let size = SizeInfo::new(5., 10., 1., 1., 0., 0., false, 0.0);
    ...
    fn strip_whitespace_at_linebreak() {
        ...
        let mut message_buffer = MessageBuffer::default();
        message_buffer.push(Message::new(input.into(), MessageType::Error));
        let size = SizeInfo::new(3., 10., 1., 1., 0., 0., false, 0.0);
