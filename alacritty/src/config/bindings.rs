...
pub fn default_key_bindings() -> Vec<KeyBinding> {
    let mut bindings = bindings!(
        ...
        Backspace, ~BindingMode::VI, ~BindingMode::SEARCH, ~BindingMode::REPORT_ALL_KEYS_AS_ESC, ~BindingMode::PALETTE; Action::Esc("\x7f".into());
        Backspace, ModifiersState::ALT,     ~BindingMode::VI, ~BindingMode::SEARCH, ~BindingMode::REPORT_ALL_KEYS_AS_ESC, ~BindingMode::DISAMBIGUATE_ESC_CODES, ~BindingMode::PALETTE; Action::Esc("\x1b\x7f".into());
        ...
        Enter => KeyLocation::Numpad, ~BindingMode::VI, ~BindingMode::SEARCH, ~BindingMode::REPORT_ALL_KEYS_AS_ESC, ~BindingMode::DISAMBIGUATE_ESC_CODES, ~BindingMode::PALETTE; Action::Esc("\n".into());
        // Vi mode.
